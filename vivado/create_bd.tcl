...
\
  ...
  # Create instance: array_mult_0, and set properties
  set array_mult_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:array_mult:1.0 array_mult_0 ]
  ...
  connect_bd_intf_net -intf_net array_mult_0_out_stream [get_bd_intf_pins array_mult_0/out_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins array_mult_0/in_stream]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins array_mult_0/s_axi_control]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  ...
  [get_bd_pins array_mult_0/ap_rst_n] \
  ...
  [get_bd_pins array_mult_0/ap_clk] \
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs array_mult_0/s_axi_control/Reg] -force
